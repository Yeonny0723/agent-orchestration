...
7. 제목과 본문을 제시하기 전에 `author-reviewable-text`에 산출물 종류가 Issue 제목과 본문임을 밝히고 선택한 템플릿과 필수 형식, 관찰된 증상이나 확정된 요구인 확인된 사실, provider의 길이 제한과 사용자 옵션을 전달한다. 반환된 최종 초안을 승인 단계에 사용한다.
